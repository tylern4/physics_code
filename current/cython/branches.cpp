...
Int_t h10_stat[MAX_PARTS];  //[gpart]
...
Float_t h10_cc_t[MAX_PARTS];  //[cc_part]
...
void getBranches(TTree *myTree) {
  ...
  myTree->SetBranchAddress("stat", h10_stat, &b_stat);
  ...
  myTree->SetBranchAddress("cc_t", h10_cc_t, &b_cc_t);
