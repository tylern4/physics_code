...
void WvsMM(std::string name = "v2_all.root") {
  ...
  for (int x = 0; x < W_bins; x++) {
    ...
    printf(hname, "MM_binned/MM_W_%0.3f_%0.3f\n", w_binned_min + (W_width * x), w_binned_min + (W_width * (x + 1)));
