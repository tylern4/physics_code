...
mv aao_rad.evt $DATA/aao_rad_$1.evt

nt10maker -t2 $DATA/aao_rad_$1.evt -o$DATA/aao_rad_$1.hbook
h2root $DATA/aao_rad_$1.hbook $DATA/aao_rad_$1.root
rm -rf $DATA/aao_rad_$1.hbook
echo -e "$RED#################$DEF"
