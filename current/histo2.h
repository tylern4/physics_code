...
TH2D *WvsQ2_e_proton_pi_found = new TH2D("WvsQ2_e_proton_pi_found","W vs Q^{2} p #pi^{+}", bins_2, w_min_2, w_max_2, bins_2, q2_min_2, q2_max_2);
TH1D *W_e_proton_pi_found = new TH1D("W_e_proton_pi_found","W p #pi^{+}",bins_2,  w_min_2, w_max_2);
TH1D *Q2_e_proton_pi_found = new TH1D("Q2_e_proton_pi_found","Q^{2} p #pi^{+}",bins_2, q2_min_2, q2_max_2);
...
//TH2D *WvsQ2_e_neutron_found = new TH2D("WvsQ2_e_neutron_found","W vs Q^{2} n", bins_2, w_min_2, w_max_2, bins_2, q2_min_2, q2_max_2);
//TH1D *W_e_neutron_found = new TH1D("W_e_neutron_found","W n",bins_2,  w_min_2, w_max_2);
//TH1D *Q2_e_neutron_found = new TH1D("Q2_e_neutron_found","Q^{2} n",bins_2, q2_min_2, q2_max_2);
...
TH2D *MomVsBeta_e_proton_pi_found = new TH2D("MomVsBeta_e_proton_pi_found","Momentum Vs #beta p #pi^{+}", bins_pvb, p_min, p_max, bins_pvb, b_min, b_max);
...
void Fill_e_proton_pi_found(double W, double Q2,double p,double beta){
...
/*void Fill_e_neutron_found(double W, double Q2,double p,double beta){
	WvsQ2_e_neutron_found->Fill(W,Q2);
	W_e_neutron_found->Fill(W);
	MomVsBeta_e_neutron_found->Fill(p,beta);
	Q2_e_neutron_found->Fill(Q2);
}*/
...
void Write_found_hists(){
	WvsQ2_e_proton_pi_found->SetXTitle("W (GeV)");
	WvsQ2_e_proton_pi_found->SetYTitle("Q^{2} (GeV^{2})");
	W_e_proton_pi_found->SetXTitle("W (GeV)");
	Q2_e_proton_pi_found->SetXTitle("Q^{2} (GeV^{2})");
	MomVsBeta_e_proton_pi_found->SetXTitle("Momentum (GeV)");
	MomVsBeta_e_proton_pi_found->SetYTitle("#beta");
	...
	//WvsQ2_e_neutron_found->SetXTitle("W (GeV)");
	//WvsQ2_e_neutron_found->SetYTitle("Q^{2} (GeV^{2})");
	//W_e_neutron_found->SetXTitle("W (GeV)");
	//Q2_e_neutron_found->SetXTitle("Q^{2} (GeV^{2})");
	//MomVsBeta_e_neutron_found->SetXTitle("Momentum (GeV)");
	//MomVsBeta_e_neutron_found->SetYTitle("#beta");

	//MomVsBeta_e_neutron_found->Write();
	//WvsQ2_e_neutron_found->Write();
	//W_e_neutron_found->Write();
	//Q2_e_neutron_found->Write();
