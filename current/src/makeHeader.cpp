...
void Header::Set_RetrunType(std::string RetrunType) {
        r_type = RetrunType;
}

void Header::Set_FuncName(std::string FuncName) {
        f_name = FuncName;
}

void Header::Set_FuncInputs(std::string FuncInputs) {
        f_input = FuncInputs;
}
...
void Header::AddText(std::string TextAdd) {
        a_text = TextAdd;
}

void Header::AddLine(std::string LineAdd) {
...
void Header::AddComment(std::string CommAdd) {
        c_text = CommAdd;
}
