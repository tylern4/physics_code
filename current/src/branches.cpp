...
void getBranches(TTree *myTree) {
  ...
  /*
    ...
    //<<< add all branches to the cache
    myTree->AddBranchToCache("p", kTRUE);
    myTree->AddBranchToCache("q", kTRUE);
    myTree->AddBranchToCache("b", kTRUE);
    myTree->AddBranchToCache("cx", kTRUE);
    myTree->AddBranchToCache("cy", kTRUE);
    myTree->AddBranchToCache("cz", kTRUE);
    myTree->AddBranchToCache("sc_t", kTRUE);
    myTree->AddBranchToCache("sc_r", kTRUE);
    myTree->AddBranchToCache("gpart", kTRUE);
    myTree->AddBranchToCache("id", kTRUE);
    myTree->AddBranchToCache("stat", kTRUE);
    myTree->AddBranchToCache("dc", kTRUE);
    myTree->AddBranchToCache("cc", kTRUE);
    myTree->AddBranchToCache("sc", kTRUE);
    myTree->AddBranchToCache("ec", kTRUE);
  */
  myTree->SetBranchStatus("*", 1);
}
