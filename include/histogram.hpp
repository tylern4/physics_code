...
*/
  ...
  TH2D_ptr ThetaVsPhi_hist = std::make_shared<TH2D>("ThetaVsPhi_hist", "Theta vs Phi", BINS, 0, PI, BINS, 0, 2 * PI);
  TH2D_ptr CosThetaVsPhi_hist =
      std::make_shared<TH2D>("CosThetaVsPhi_hist", "Cos Theta vs Phi", BINS, -1.0, 1.0, BINS, 0, 2 * PI);
  ...
  TH2D_ptr Theta_vs_mom = std::make_shared<TH2D>("Theta_vs_mom", "Theta_vs_mom", BINS, p_min, p_max, BINS, 0, 70);
  std::vector<TH2D_ptr> Theta_vs_mom_sec;
  ...
  TH1D_ptr Beam_Position_Z = std::make_shared<TH1D>("Beam_Position_Z", "Beam_Position_Z", 10 * BINS, -10, 15.0);
  ...
  TH1D_ptr Missing_Mass_square =
      std::make_shared<TH1D>("Missing_Mass_square", "Missing Mass square", BINS_MM, 0.7, 1.5);
  ...
  TH1D_ptr Missing_Mass_square_strict =
      std::make_shared<TH1D>("Missing_Mass_square_strict", "Missing Mass square", BINS_MM, 0.7, 1.5);
