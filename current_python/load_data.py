...
if __name__ == '__main__':
	...
	parser.add_argument('input', type=str, help="Input directory for *.pkl files")
	parser.add_argument('output', type=str, nargs='?', help="Output for pdf files", default='.')
	parser.add_argument('-s', help="Save outputs to pdf", default=False, action='store_true')
	parser.add_argument('-p', help="Save outputs to pickle", default=False, action='store_true')
	parser.add_argument('-o', help="Open outputs as plots", default=False, action='store_true')
