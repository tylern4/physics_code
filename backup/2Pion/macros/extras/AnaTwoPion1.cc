		...
		if (tgt[j] != 0){
		   if(j==0){
		      if(pairV4.P()>0 and pairV4.P()<=0.5){ 
  		      ...
  		      else if(pairV4.P()>0.5 and pairV4.P()<=1){
		      ...
		      else if(pairV4.P()>1 and pairV4.P()<=1.5){
		      ...
		      else if(pairV4.P()>1.5 and pairV4.P()<=2){
		      ...
		      else if(pairV4.P()>2 and pairV4.P()<=2.5){
		      ...
		      else if(pairV4.P()>2.5 and pairV4.P()<=3){
