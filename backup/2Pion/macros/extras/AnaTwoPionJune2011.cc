      ...
      for(j=0;j<nType;j++){                                     // loop over vz type, [0,in target], [1,after target]
		...
		if (cuts && tgt[j]){
		   if(j==0){
		      ...
		      if(tgt[j] == 1) MassCutAroundTarget[1]->Fill(pairM);
		      else if(tgt[j] == 2) MassCutAroundTarget[2]->Fill(pairM);
		      else if(tgt[j] == 3) MassCutAroundTarget[3]->Fill(pairM);
		      else if(tgt[j] == 4) MassCutAroundTarget[4]->Fill(pairM);
		      ...
		      if(pairV4.P()>0 and pairV4.P()<=0.35){ 
		         ...
		         else if(tgt[j] == 2) MassCutAroundTgt[2][1]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAroundTgt[3][1]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAroundTgt[4][1]->Fill(pairM);}
		         ...
		         else if(tgt[j] == 2) MassCutAroundTgt[2][2]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAroundTgt[3][2]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAroundTgt[4][2]->Fill(pairM);}
		         ...
		         else if(tgt[j] == 2) MassCutAroundTgt[2][3]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAroundTgt[3][3]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAroundTgt[4][3]->Fill(pairM);}
		         ...
		         else if(tgt[j] == 2) MassCutAroundTgt[2][4]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAroundTgt[3][4]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAroundTgt[4][4]->Fill(pairM);}
		         ...
		         else if(tgt[j] == 2) MassCutAroundTgt[2][5]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAroundTgt[3][5]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAroundTgt[4][5]->Fill(pairM);}
		         ...
		         else if(tgt[j] == 2) MassCutAroundTgt[2][6]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAroundTgt[3][6]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAroundTgt[4][6]->Fill(pairM);}
		      
		   }

		   else if(j==1){
		   
		      if(tgt[j] == 1) MassCutAfterTarget[1]->Fill(pairM);
		      else if(tgt[j] == 2) MassCutAfterTarget[2]->Fill(pairM);
		      else if(tgt[j] == 3) MassCutAfterTarget[3]->Fill(pairM);
		      else if(tgt[j] == 4) MassCutAfterTarget[4]->Fill(pairM);
		   
		      if(pairV4.P()>0 and pairV4.P()<=0.35){ 
		         MomentumCutAfter[1]->Fill(pairV4.P());
		         MassCutAfter[1]->Fill(pairM);
		         if(tgt[j] == 1) MassCutAfterTgt[1][1]->Fill(pairM);
		         else if(tgt[j] == 2) MassCutAfterTgt[2][1]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAfterTgt[3][1]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAfterTgt[4][1]->Fill(pairM);}
  		      else if(pairV4.P()>0.35 and pairV4.P()<=0.70){
		         MomentumCutAfter[2]->Fill(pairV4.P());
		         MassCutAfter[2]->Fill(pairM);
		         if(tgt[j] == 1) MassCutAfterTgt[1][2]->Fill(pairM);
		         else if(tgt[j] == 2) MassCutAfterTgt[2][2]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAfterTgt[3][2]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAfterTgt[4][2]->Fill(pairM);}
		      else if(pairV4.P()>0.70 and pairV4.P()<=1.05){
		         MomentumCutAfter[3]->Fill(pairV4.P());
		         MassCutAfter[3]->Fill(pairM);
		         if(tgt[j] == 1) MassCutAfterTgt[1][3]->Fill(pairM);
		         else if(tgt[j] == 2) MassCutAfterTgt[2][3]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAfterTgt[3][3]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAfterTgt[4][3]->Fill(pairM);}
		      else if(pairV4.P()>1.05 and pairV4.P()<=1.40){
		         MomentumCutAfter[4]->Fill(pairV4.P());
		         MassCutAfter[4]->Fill(pairM);
		         if(tgt[j] == 1) MassCutAfterTgt[1][4]->Fill(pairM);
		         else if(tgt[j] == 2) MassCutAfterTgt[2][4]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAfterTgt[3][4]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAfterTgt[4][4]->Fill(pairM);}
		      else if(pairV4.P()>1.40 and pairV4.P()<=1.75){
		         MomentumCutAfter[5]->Fill(pairV4.P());
		         MassCutAfter[5]->Fill(pairM);
		         if(tgt[j] == 1) MassCutAfterTgt[1][5]->Fill(pairM);
		         else if(tgt[j] == 2) MassCutAfterTgt[2][5]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAfterTgt[3][5]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAfterTgt[4][5]->Fill(pairM);}
		      else if(pairV4.P()>1.75 and pairV4.P()<=2.10){
		         MomentumCutAfter[6]->Fill(pairV4.P());
		         MassCutAfter[6]->Fill(pairM);
		         if(tgt[j] == 1) MassCutAfterTgt[1][6]->Fill(pairM);
		         else if(tgt[j] == 2) MassCutAfterTgt[2][6]->Fill(pairM);
		         else if(tgt[j] == 3) MassCutAfterTgt[3][6]->Fill(pairM);
		         else if(tgt[j] == 4) MassCutAfterTgt[4][6]->Fill(pairM);}
		      }
		   }
