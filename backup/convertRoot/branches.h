/*
Needs to be changed in order to read branches from the root files for E1D
change branch names and associated variables to match
*/
...
void getBranches(TTree* myTree){
	...
	myTree->SetBranchAddress("evtype", &evtype);		//event type
