...
WorkspacePath          := "/home/tylern/DATA/code"
ProjectPath            := "/home/tylern/DATA/code"
...
ObjectsFileList        :="/home/tylern/DATA/code/test.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/test$(ObjectSuffix): test.cpp $(IntermediateDirectory)/test$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/tylern/DATA/code/test.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/test$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/test$(DependSuffix): test.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/test$(ObjectSuffix) -MF$(IntermediateDirectory)/test$(DependSuffix) -MM "/home/tylern/DATA/code/test.cpp"

$(IntermediateDirectory)/test$(PreprocessSuffix): test.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/test$(PreprocessSuffix) "/home/tylern/DATA/code/test.cpp"
