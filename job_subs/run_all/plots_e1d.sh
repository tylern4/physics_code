...
##SBATCH -p msmoms
##SBATCH -p BigMem,defq-48core,gpu-v100-16gb,gpu-v100-32gb,msmoms
...
/work/apps/python3/anaconda3/2020.02/bin/python acceptance.py --draw_kin --mc /work/tylerns/e1d/outputs/csv/mc_osg_e1d.csv --data /work/tylerns/e1d/outputs/csv/data_e1d.csv --folder /work/tylerns/e1d/outputs/plots
