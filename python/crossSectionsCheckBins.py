                    ...
                    for name, cuts in cut_fids.items():
                        if cuts == 0:
                            ...
                            _data_y, _x = hist_data(
                                data[data.cut_fid], density=False, bins=b)
                            _empty_y, _ = hist_data(
                                data_e[data_e.cut_fid], density=False, bins=b)
                            _mc_rec_y, _ = hist_data(
                                data_mc[data_mc.cut_fid], density=False, bins=b)
                        elif cuts == 1:
                            # Histogram the data for plotting
                            marker = "^"
                            _data_y, _x = hist_data(
                            ...
                            marker = 'd'
                            _data_y, _x = hist_data(
                                data, density=False, bins=b)
                            _empty_y, _ = hist_data(
                                data_e, density=False, bins=b)
                            _mc_rec_y, _ = hist_data(
                        ...
                        __phis = np.linspace(0, 2 * np.pi, b)
